...
<div class="searchBox">
<form name="form1">
<input type ="text" onchange="categoryChange()" id = "location_first" name = "location_first">
...
function categoryChange(e) {
	...
	var local_full = document.getElementById('location_first').value;
	
	if(local == "서울") var d = location_seoul;
	else if(local == "부산") var d = location_busan;
	else if(local == "대구") var d = location_daegu;
	else if(local == "인천") var d = location_incheon;
	else if(local == "광주") var d = location_gwangju;
	else if(local == "대전") var d = location_daejeon;
	else if(local == "울산") var d = location_ulsan;
	else if(local == "강원") var d = location_gangwon;
	else if(local == "경기") var d = location_gyeonggi;
	else if(local == "경상남도" || local == "경남") var d = location_gyeongnam;
	else if(local == "경상북도" || local == "경북") var d = location_kyeongbuk;
	else if(local == "전라남도" || local == "전남") var d = location_jeonman;
	else if(local == "전라북도" || local == "전북") var d = location_jeonbuk;
	else if(local == "제주") var d = location_jeju;
	else if(local == "충청남도" || local == "충남") var d = location_chungnam;
	else if(local == "충청북도" || local == "충북") var d = location_chungbuk;
	else if(local == "세종") var d = location_sejong;
